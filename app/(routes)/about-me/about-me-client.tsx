...
// ── Rich snippet Person + ProfilePage ─────────────────────────────
const personJsonLd = {
    ...
    mainEntity: {
        ...
        description:
            "Consultor SEO freelancer y desarrollador Front-End con más de 3 años de experiencia en posicionamiento orgánico, WordPress, Shopify y Next.js.",
        url: "https://www.ledexcorp.site/about-me",
        image: "https://www.ledexcorp.site/leoyo.webp",
        sameAs: [
        ...
        alumniOf: {
            ...
            name: "AIEP",
            description: "Técnico en Programación y Análisis de Sistemas",
        },
        address: {
            "@type": "PostalAddress",
            ...
            <ContainerPage>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center mb-20 px-4">
                    <div className="relative w-full aspect-[4/5] rounded-2xl overflow-hidden shadow-xl order-2 md:order-1">
                        <Image
                            ...
                            alt="Leonel Delgado — Graduación AIEP Técnico en Programación"
                            fill
                            className="object-cover object-center"
                            sizes="(max-width: 768px) 100vw, 50vw"
                        />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center mb-20 px-4">
                    ...
                    <div className="relative w-full aspect-[3/1] rounded-2xl overflow-hidden shadow-xl bg-[#f0f2f5]">
                        <Image
                            src="/seo.webp"
                            alt="Resultados SEO reales en Google Search Console — Leonel Delgado"
                            fill
