...
const WHATSAPP_NUMBER = "34624136170"; // ← Cambia esto por tu número real
...
const Header = () => {
    ...
    // Cierra el dropdown al hacer click fuera (para mobile)
    useEffect(() => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Iconos sociales (mismos que mobile) + WhatsApp CTA */}
                <div className="flex items-center gap-3 shrink-0">
                    {socialNetworks.map(({ logo, src, id, title }) =>
                        Array.isArray(src) ? (
                            /* Dropdown CV (hover desktop) */
                            <div
                                key={id}
                                ref={dropdownRef}
                                className="relative"
                            ...
                            >
                                <button
                                    ...
                                    className="flex items-center justify-center text-base transition-all duration-300 hover:text-secondary text-white/80"
                                >
                                    {logo}
                                </button>
                                {isDropdownOpen && (
                    ...
                    <Link
                        ...
                        "
                    >
                        {/* WhatsApp SVG inline (carga instantánea, sin dependencia) */}
                        <svg
            ...
            {/* ============================================================
                MOBILE NAV (sin cambios estructurales, solo fix del dropdown CV)
            ============================================================ */}
